...
import java.util.Objects;
    /**
     * Classe ExcelPane che estende JPanel che costituisce la tabella ed ogni bottone e campo del interfaccia UI
     */
public class ExcelPane extends JPanel implements KeyListener {
    /**
     * Stato della classe ExcellPane
     */
    ...
    /**
     * Dal MenuBar viene eseguita questa funzione che ritorna un arraylist,
     * piena di tutti gli elementi non vuoti della colonna selezionata.
     * Serve per creare il grafico della lista o della barra.
     */
